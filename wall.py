...
from flask import Flask, request, render_template, make_response, redirect, Markup
...
def add_message():
    ...
    msg = Markup.escape(str(request.form.get('m').strip()))
...
def clear_wall():
    """Deletes all the messages on the wall and replaces with default message."""
    wall_clear()
    print "clear-wall from wall.py is running!"
